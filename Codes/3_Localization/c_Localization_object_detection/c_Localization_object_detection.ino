/* 
  ...
  - Bluetooth Drive
  - Localization
  - Obstical detection and distance informing
...
void measure_distance(){
    ...
    distance= duration*0.034/2;Serial.println(distance);
    }

void send_data(){
  if( millis() - prev_time>1000){
  SerialBT.print("X =");SerialBT.print(x);SerialBT.print(" | ");
  SerialBT.print("Y =");SerialBT.println(y);
  prev_time=millis();  
  if(distance<15){
      SerialBT.print("Object at ");SerialBT.print(distance);
      SerialBT.println("cm");}
